# === BBOT 3.4 - anti-spam, indywidualne MIN_NOTIONAL === 
...
class TelegramBot:
    ...
    async def start(self, u, c): await u.message.reply_text("🤖 Bot działa!")
...
if __name__ == "__main__":
    print("🚀 Start BBOT 2.2 (anti-spam, indywidualne min_notional)")
